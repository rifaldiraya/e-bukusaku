...
const text = (v) => v.match(arabicRegex) ? <Typography variant='body1' style={{margin: 5, fontSize: 18}}>{v}</Typography> : <Typography variant='body1' style={{margin: 5, fontSize: 14}}>{v}</Typography>
                            ...
                            if((i) % 3 === 0 ){
                                return (
                                    <Fragment key={i}>
                                        ...
                                        {v === 'بِسْمِ اللهِ الرّحْمنِ الرّحِيْمِ' ? <Typography variant='body1' style={{margin: 5, fontSize: 22}}>بِسْمِ اللهِ الرّحْمنِ الرّحِيْمِ</Typography> :text(v)}
                                    </Fragment>
                                )
                            } else{
                                return text(v)
